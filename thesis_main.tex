%-----------------------------------
% Definition des Dokumentes und Einbindung benötigter Pakete
%-----------------------------------
...
% Dokumentensprache
%-----------------------------------
%\def\EUFHEN{}% Einkommentieren um die Dokumentensprache nach Englisch zu ändern
\newif\ifde
\newif\ifen
...
% Times New Roman Font, EUFH Vorgabe
...
\renewcommand{\nomname}{\langde{Abkürzungsverzeichnis}\langen{List of Abbreviations}}
...
% Change Quellcodeverzeichnis Name
...
%-----------------------------------
%\newpage
%\section*{\langde{Anhang}\langen{Appendix}} %Überschrift "Anhang", ohne Nummerierung
...
\addtocontents{toc}{\protect\setcounter{tocdepth}{0}} %
	\renewcommand{\thesection}{\langde{Anhang}\langen{Appendix} \Roman{section}}
	\renewcommand\thesubsection{\langde{Anhang}\langen{Appendix} \Roman{section}.\Roman{subsection}}
...
%-----------------------------------
% Eidesstattliche Erklärung (In elektronischen Versionen von Arbeiten wird diese nicht verwendet)
%-----------------------------------
